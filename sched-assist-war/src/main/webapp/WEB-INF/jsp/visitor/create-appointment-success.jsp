...
<p>
<spring:message code="create.appointment.success" arguments="${owner.calendarAccount.displayName};${timeFormatted};${dateFormatted};${event.location.value}" argumentSeparator=";"/>
</p>
<c:if test="${ownerRemindersPreference.enabled }">
<p>
<spring:message code="create.appointment.reminder" arguments="${owner.calendarAccount.displayName};${ownerRemindersPreference.hours}" argumentSeparator=";"/>
</p>
</c:if>
