...
<div class="info">
<spring:message code="public.profiles.none"/><br/>
If you are looking for an Undergraduate Advisor, be sure to check the Undergraduate Advisor Toolkit at:<br/>
...
<spring:message code="public.profiles.help"/>:
</div>
<div id="publiclist">
<ul>
...
<ul>
<c:if test="${showPrev}">
<c:url value="/public/browse.html" var="prevLink">
...
<c:if test="${showNext}">
<c:url value="/public/browse.html" var="nextLink">
