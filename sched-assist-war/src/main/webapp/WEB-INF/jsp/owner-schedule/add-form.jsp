...
<head>
<title><spring:message code="application.name"/> - <spring:message code="add.availability.block"/></title>
...
<form:form>
<fieldset>
<legend><spring:message code="add.availability.block"/></legend>
<p><spring:message code="add.availability.block.help"/></p>
...
<br/>
<br/>
<label for="visitorLimit"><spring:message code="visitor.limit"/>:</label>&nbsp;
<form:input path="visitorLimit" cssStyle="width: 2em;"/>
<br/>
<br/>
