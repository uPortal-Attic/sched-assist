...
<form:form>
<fieldset>
<legend><spring:message code="remove.relationship"/></legend>
<p class="info"><spring:message code="remove.relationship.help"/></p>
...
<br/>
<br/>
<input type="submit" value="<spring:message code="revoke"/>"/>
</fieldset>
</form:form>
</div> <!-- ownerform -->
