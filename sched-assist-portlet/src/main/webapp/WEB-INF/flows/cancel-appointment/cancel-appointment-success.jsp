...
<div class="success">
<fmt:formatDate value="${eventCancel.startDate}" type="time" pattern="hh:mm a" var="timeFormatted"/>
<fmt:formatDate value="${eventCancel.startDate}" type="date" pattern="MM/dd/yyyy" var="dateFormatted"/>
<p><spring:message code="cancel.appointment.success" arguments="${targetOwner.calendarAccount.displayName};${timeFormatted};${dateFormatted}" argumentSeparator=";"/></p>
